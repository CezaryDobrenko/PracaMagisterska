...
from scrapper.tests.factories import RequestFactory, UserFactory, ApiKeyFactory, FolderFactory
...
class FolderTest(TestCase):
    ...
    def test_authenticated_user_folders_query(self):
        ...
        expected = {'data': {'me': {'folders': {'edges': [{'node': {'name': folder_1.name}}, {'node': {'name': folder_2.name}}]}}}}
    ...
    def test_authenticated_user_folders_filter_query(self):
        ...
        expected = {'data': {'me': {'folders': {'edges': [{'node': {'name': folder.name}}]}}}}
