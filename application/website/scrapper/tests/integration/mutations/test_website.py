...
from scrapper.tests.factories import FolderFactory, RequestFactory, UserFactory, ApiKeyFactory, WebsiteFactory
...
class WebsiteTest(TestCase):
    ...
    def test_authenticated_user_update_website_mutation(self):
        website = WebsiteFactory(is_simplified=False, is_ready=False, description="old_desc", folder=self.folder)
        is_ready = "true"
        is_simplified = "true"
        ...
        expected = {'updateWebsite': {'website': {'isSimplified': True, 'isReady': True, 'description': description}}}
    ...
    def test_authenticated_user_update_other_user_website_mutation(self):
        ...
        assert result["errors"][0]["message"] == "This website cannot be edited by given api_key"
